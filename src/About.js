...
function About() {
  ...
  return(
    <Container className="About mt-5">
	  ...
	  <p>This app is <Link to='https://github.com/nostrband/nostr-app-manager'>open source</Link>, it has no backend and no trackers. Your app settings are stored in your browser, and your app list is only published if you choose to do so.</p>
	  ...
	  <p>Check out the <Link to="https://github.com/nostr-protocol/nips/pull/530">NIP proposal</Link> for publishing apps on Nostr.</p>
	</Col>
      </Row>
      <Row>
        <Col><Footer /></Col>
