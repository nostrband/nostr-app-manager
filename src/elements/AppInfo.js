...
const AppInfo = (props) => {
  ...
  const isAllowEdit = () => { return cmn.isAuthed() && cmn.getLoginPubkey() === props.app.pubkey; };
  ...
  return (
	...
	<Col>
	  <div className="me-auto">
		...
		<Link to={app.website} target="_blank">{app.website}</Link>
	      </div>
	    )}
	    {app.lud16 && (
	      <div className="text-muted">
	...
	<Col xs="auto">
	  {app.picture && (<img alt="" className="profile" width="64" height="64"
			     src={app.picture} />)}
	  {allowEdit && (
	    <div className="mt-2 d-flex justify-content-center">
	      <Link to={editUrl}><Button size="sm" variant="outline-secondary">Edit</Button></Link>
	    </div>
	  )}
	</Col>
      </Row>
